...
contains two unknowns. To integrate, we need to express $[\mathrm{B}]$ in terms of $[\mathrm{A}]$. For 1:1 stoichiometry, mass balance ([Lecture 1](#introduction-to-chemical-kinetics)) tells us that A and B are consumed in equal amounts, so at any time $t$:
