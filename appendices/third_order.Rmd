...
This explains an observation from [Lecture 1](#introduction-to-chemical-kinetics): termolecular processes are rare, and apparent third-order kinetics usually arise from sequential bimolecular steps (as in the NO oxidation mechanism discussed in [Lecture 7](#unimolecular-reactions-and-collision-dynamics)) rather than genuine three-body collisions.
