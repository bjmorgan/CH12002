...
$$\frac{\mathrm{d}[\mathrm{B}]}{\mathrm{d}t} = -k'[\mathrm{B}]$$
...
1. Plot $[A]$ vs $t$ to test for zeroth-order (straight line)
2. Plot $ln[A]$ vs $t$ to test for first-order (straight line)
3. Plot $1/[A]$ vs $t$ to test for second-order (straight line)
