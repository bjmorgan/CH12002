...
One might expect that increasing the pressure of a reactant always increases the reaction rate. But when two species compete for the same adsorption sites, increasing the pressure of one reactant can *decrease* the overall rate by blocking sites needed by the other. This leads to the counterintuitive phenomenon of *negative reaction orders*, discussed in Appendix \@ref(appendix-negative-orders).
