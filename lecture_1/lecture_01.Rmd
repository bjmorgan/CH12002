...
## Chemical Kinetics → Describing $[\text{A}](t)$
...
1. **Unimolecular processes** involve the transformation of a single molecule:
   ...
   Typical examples include isomerization reactions (where a molecule rearranges its bonds without changing composition) and decomposition reactions (where a molecule breaks into smaller fragments).
