...
The CFC-ozone reaction is a straightforward chain: a single radical carrier ($\mathrm{Cl}^{\bullet}$) cycles through one propagation loop until termination removes it. Not all chain reactions are so simple. We first encountered the gas-phase reaction of hydrogen with bromine in Lecture 1, where its deceptively simple stoichiometry suggested a straightforward bimolecular process. The overall reaction,
